      ...
      <div className="max-w-3xl mx-auto">
        <FadeIn>
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #8d7350 0%, #5c3d1a 100%)' }}
          >
            <div className="space-y-5 mb-10">
              {[
                ...
                <p key={i} className="text-white/85 text-base leading-relaxed pl-4 border-l-2 border-white/20">
                  {text}
                </p>
              ))}
            </div>
            ...
            <ol className="space-y-3 pl-5 list-decimal marker:text-gold">
              {results.map((r) => (
