        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-14 items-center">
          <FadeIn>
            <img
              ...
              alt="Василий Горшков за пианино в концертном зале"
              className="w-full rounded-2xl object-cover shadow-md hover:animate-scaleHover transition-transform duration-300"
              style={{ maxWidth: 420 }}
            />
          </FadeIn>
          ...
          <FadeIn delay={0.15}>
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold tracking-tighter text-ink mb-2">
              Василий Горшков
            </h2>
